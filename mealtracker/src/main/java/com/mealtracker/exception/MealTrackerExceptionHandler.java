package com.mealtracker.exception;

import com.mealtracker.exception.message.ApiResponseError;
...
@ControllerAdvice
public class MealTrackerExceptionHandler extends ResponseEntityExceptionHandler {

    Logger logger = LoggerFactory.getLogger(MealTrackerExceptionHandler.class);
